<x-app-layout>
    {{-- Judul Halaman --}}
    <x-page-title>Kategori Produk</x-page-title>
            ...
            <div class="col-lg-7 col-xl-6">
                ...
                <form action="{{ route('categories.index') }}" method="GET">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control form-search py-2" value="{{ request('search') }}" placeholder="Cari kategori ..." autocomplete="off">
    ...
    <div class="bg-white rounded-2 shadow-sm pt-4 px-4 pb-3 mb-5">
        <ul class="nav nav-pills mb-4">
            <li class="nav-item">
                <a class="nav-link active btn-sm" href="{{ route('categories.index') }}">Kategori Produk</a>
            </li>
            <li class="nav-item">
                <a class="nav-link btn-sm" href="{{ route('units.index') }}">Satuan Produk</a>
            </li>
            <li class="nav-item">
                <a class="nav-link btn-sm" href="{{ route('suppliers.index') }}">Pemasok Produk</a>
            </li>
        </ul>        
                    ...
                    <tr>
                        ...
                        @if (Auth::user()->role === 'admin')
                            <td width="70" class="text-center">
                                <a href="{{ route('categories.edit', $category->id) }}" class="btn btn-primary btn-sm m-1" data-bs-tooltip="tooltip" data-bs-title="Ubah">
                                    <i class="ti ti-edit"></i>
                                </a>
                                {{-- <button type="button" class="btn btn-danger btn-sm m-1" data-bs-toggle="modal" data-bs-target="#modalDelete{{ $category->id }}" data-bs-tooltip="tooltip" data-bs-title="Hapus">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    Apakah Anda yakin ingin menghapus <span class="fw-bold">{{ $category->name }}</span>?
                                </div>
